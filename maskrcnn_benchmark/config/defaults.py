...
_C.INPUT.MIN_SIZE_TRAIN = 1024 # (800,)
# Maximum size of the side of the image during training
_C.INPUT.MAX_SIZE_TRAIN = 2048
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST = 1024
# Maximum size of the side of the image during testing
_C.INPUT.MAX_SIZE_TEST = 2048
...
_C.MODEL.RPN.POSITIVE_FRACTION = 0.5 # 0.5
...
_C.MODEL.ROI_MASK_HEAD.POSTPROCESS_MASKS_THRESHOLD = 0.5  # 0.5
# Dilation
