...
dataset_dir = '/home/duane/Mine/DeepLearning/PytorchPro/maskrcnn-benchmark/datasets/coco/test2014/'
csv_origin = './jys_botup_c_t90_new.csv'
csv_unet   = './unet.csv'
csv_submit = './rle_submit_new.csv'
