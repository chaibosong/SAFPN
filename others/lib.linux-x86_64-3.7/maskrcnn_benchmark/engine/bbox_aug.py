...
def im_detect_bbox_aug(model, images, device):
    ...
    boxlists_ts = []
    print("images的tensors属性内容：",iamges.tensors)
    print("images的tensors属性shape", iamges.tensors.shape)
    print("images的image_sizes属性内容：", iamges.image_sizes)
    print("images的image_sizes属性类型：", type(iamges.image_sizes))
